...
Formula.prototype.frac=function(){
	var tags=this.root.getElementsByName('frac');	//document.getElementsByTagName('frac');	
...
Formula.prototype.equation=function(){
	var tags=this.root.getElementsByName('equation');//document.getElementsByTagName('equation');	
	for(var i=0;i<tags.length;i++){		
...
// 	var tags=this.root.getElementsByName('division');//document.getElementsByTagName('division');	
// 	for(var i=0;i<tags.length;i++){
